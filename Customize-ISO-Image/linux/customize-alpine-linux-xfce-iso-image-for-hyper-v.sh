...
then
    ...
    then
        ...
        then
            ...
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-alpine-linux-xfce-installation-script.desktop"
            ...
            sudo sed -i "s/<VIRTUAL MACHINE NAME>/$1/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/setup-alpine.answerfile"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/custom-alpinelinux-first-time.start.disabled"
            sudo sed -i "s/<USER PASSWORD>/$5/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/custom-alpinelinux-first-time.start.disabled"
            sudo sed -i "s/<SHARE NAME>/$6/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/custom-alpinelinux-first-time.start.disabled"
            sudo sed -i "s/<SHARE USER NAME>/$7/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/custom-alpinelinux-first-time.start.disabled"
            sudo sed -i "s/<SHARE USER PASSWORD>/$8/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/custom-alpinelinux-first-time.start.disabled"
            sudo sed -i "s/<SHARE USER DOMAIN>/$9/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/custom-alpinelinux-first-time.start.disabled"
