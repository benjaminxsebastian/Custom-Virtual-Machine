...
then
    ...
    then
        ...
        then
            ...
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-first-time.start.disabled"
            sudo sed -i "s/<USER PASSWORD>/$5/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-first-time.start.disabled"
