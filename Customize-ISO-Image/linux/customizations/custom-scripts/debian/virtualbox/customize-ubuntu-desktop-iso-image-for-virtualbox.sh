    ...
    then
        ...
        then
            ...
            then
                ...
                sudo sed -i "s/<VIRTUALIZATION PLATFORM>/virtualbox/g" "$destinationIsoImageDirectory/nocloud/user-data"
                sudo sed -i "s/<USER PASSWORD>/$5/g" "$destinationIsoImageDirectory/nocloud/user-data"
                sudo sed -i 's/"<SHARE NAME>"//g' "$destinationIsoImageDirectory/nocloud/user-data"
                sudo sed -i 's/"<SHARE USER NAME>"//g' "$destinationIsoImageDirectory/nocloud/user-data"
                sudo sed -i 's/"<SHARE USER PASSWORD>"//g' "$destinationIsoImageDirectory/nocloud/user-data"
                sudo sed -i 's/"<SHARE USER DOMAIN>"//g' "$destinationIsoImageDirectory/nocloud/user-data"
                sudo touch "$destinationIsoImageDirectory/nocloud/meta-data"
                sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/customize-virtualbox-ubuntu-desktop-installation.sh"
                sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-virtualbox-ubuntu-desktop-installation-script.desktop"
                sudo sed -i "s/<USER PASSWORD>/$5/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-virtualbox-ubuntu-desktop-installation-script.desktop"
