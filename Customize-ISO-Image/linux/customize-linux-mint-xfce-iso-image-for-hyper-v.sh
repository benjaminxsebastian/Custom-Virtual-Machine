...
then
    ...
    then
        ...
        then
            ...
            sudo cp -r -v -f "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/linux-mint/." "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts"
            ...
            sudo sed -i "s/<USER NAME>/$3/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/logout-console-session.desktop"
            sudo sed -i "s/<USER NAME>/$3/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/hyper-v/launch-install-logout-console-session.sh"
            sudo sed -i "s/<USER NAME>/$3/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-linux-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<USER PASSWORD>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-linux-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE NAME>/$5/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-linux-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE USER NAME>/$6/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-linux-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE USER PASSWORD>/$7/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-linux-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE USER DOMAIN>/$8/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-linux-mint-xfce-installation-script.desktop"
