...
then
    ...
    then
        ...
        then
            ...
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/customize-hyper-v-alpine-linux-xfce-installation.sh"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/customize-virtualbox-alpine-linux-xfce-installation.sh"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/customize-virtual-machine-manager-alpine-linux-xfce-installation.sh"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-virtual-machine-manager-alpine-linux-xfce-installation-script.desktop"
            ...
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/power-manager.sh"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/configure-firefox.sh"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/install-pulseaudio.sh"
            sudo sed -i "s/<VIRTUAL MACHINE NAME>/$1/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/setup-alpine.answerfile"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-base-first-time.start.disabled"
            sudo sed -i "s/<USER PASSWORD>/$5/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-base-first-time.start.disabled"
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-browser-first-time.start.disabled"
            sudo sed -i "s/<USER PASSWORD>/$5/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-browser-first-time.start.disabled"
            if echo "$1" | grep -i -q "browser"; then
                sudo cp -v -f "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-browser-first-time.start.disabled" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-first-time.start.disabled"
            else
                sudo cp -v -f "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-base-first-time.start.disabled" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/custom-alpinelinux-first-time.start.disabled"
            fi
            sudo sed -i "s/<USER NAME>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/custom-scripts/virtual-machine-manager/trigger-reimage.desktop"
