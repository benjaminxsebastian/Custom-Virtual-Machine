...
then
    ...
    #---
        ...
        then
            ...
            sudo sed -i "s/<USER NAME>/$3/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<USER PASSWORD>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE NAME>/$5/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE USER NAME>/$6/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE USER PASSWORD>/$7/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-mint-xfce-installation-script.desktop"
            sudo sed -i "s/<SHARE USER DOMAIN>/$8/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-hyper-v-mint-xfce-installation-script.desktop"
