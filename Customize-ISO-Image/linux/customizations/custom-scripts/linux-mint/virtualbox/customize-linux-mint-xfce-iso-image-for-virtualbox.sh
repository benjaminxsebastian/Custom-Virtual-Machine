    ...
    then
        ...
        then
            ...
            then
                ...
                sudo sed -i "s/<USER NAME>/$3/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-virtualbox-linux-mint-xfce-installation-script.desktop"
                sudo sed -i "s/<USER PASSWORD>/$4/g" "$destinationIsoImageDirectory/$customizationsDirectory/launch-customize-virtualbox-linux-mint-xfce-installation-script.desktop"
